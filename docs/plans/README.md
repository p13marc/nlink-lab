...
| [113](113-keyword-context-sensitivity.md) | Fix keyword stealing identifiers | Medium | Ready (P0) |
...
| [116](116-shell-run-syntax.md) | Shell-style `run` syntax | Small | Ready (P2) |
