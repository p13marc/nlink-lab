...
(known_property ["interfaces" "listen" "key" "peers" "fwmark" "address" "vni" "local" "remote" "underlay" "ssid" "channel" "wpa2" "mesh-id" "interval" "timeout" "retries" "members" "mode" "miimon" "lacp-rate" "xmit-hash" "min-links" "updelay" "downdelay" "parent" "id" "protocol"] @keyword)
